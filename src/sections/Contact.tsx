...
export const Contact = () => {
  return (
    <footer
      id="contact"
      className="pt-6 pb-6 px-6 bg-[#05050a] text-white scroll-mt-20"
    >
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          ...
          <div className="flex space-x-6 md:space-x-8">
            ...
            <a
              href="mailto:garryhardyansyah23@gmail.com"
              target="_blank"
              className="text-gray-500 hover:text-red-500 transition-all duration-300 transform hover:scale-125 hover:-translate-y-1"
            >
              <Mail size={24} />
            </a>
          </div>
