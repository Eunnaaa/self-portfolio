      ...
      <div className="max-w-7xl mx-auto">
        <h1 className="text-7xl md:text-9xl font-bold tracking-tighter leading-none flex flex-wrap items-baseline gap-x-4 md:gap-x-6">
          ...
          <span className="text-gray-400 font-bold flex items-baseline">
            {displayText}
            <span className="w-1 h-[0.7em] md:w-3 bg-gray-400 ml-2 animate-pulse" />
          </span>
        </h1>

        <p className="mt-24 text-xl md:text-2xl text-gray-500 max-w-6xl leading-relaxed tracking-tight">
          Saya Gary Hardyansyah, seorang mahasiswa informatika semester 3 yang berkompeten 
          dalam dunia teknologi dengan minat dalam pengembangan perangkat lunak dan 
          pengembangan web. Memiliki pengalaman magang dan freelance sebagai pengajar 
